...
from .forms import SignupForm, LoginForm, UserForm, DoctorCreationForm
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                return render(request, 'accounts/login.html', {'form': form, 'error_message': 'Invalid credentials'})
    else:
        form = LoginForm()
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if user is not None and user.role == 'patient':
                ...
                return render(request, 'accounts/login.html', {'form': form, 'error_message': 'Invalid credentials or not a patient'})
    else:
        form = LoginForm()
    return render(request, 'accounts/login.html', {'form': form})
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if user is not None and user.role == 'doctor':
                ...
                return render(request, 'accounts/login.html', {'form': form, 'error_message': 'Invalid credentials or not a doctor'})
    else:
        form = LoginForm()
    return render(request, 'accounts/login.html', {'form': form})
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if user is not None and user.role == 'admin':
                ...
                return render(request, 'accounts/login.html', {'form': form, 'error_message': 'Invalid credentials or not an admin'})
    else:
        form = LoginForm()
    return render(request, 'accounts/login.html', {'form': form})
...
#             return render(request, 'accounts/doctor_dashboard.html')
#         else:
#             print("Authenticated but not doctor")
#             return redirect('login')
#     else:
#         print("Not authenticated as doctor")
#         return redirect('login')
